...
<div>
      {sessionData.profiles === null ? (<div className="text-center text-white"><h1>Looks like you don't have a profile</h1></div>) : (
      ...
      <div className="grid grid-col-3 grid-flow-col text-white justify-items-center font-montserrat">
        ...
        <div className="grid grid-flow-col grid-col-3 space-y-36 mt-10">
