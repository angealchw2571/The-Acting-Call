        ...
        <div className="grid grid-flow-col grid-col-3 space-y-36 ">
          <div className=" details row-span-2 col-span-2 ml-10 leading-loose ">
            ...
            <div className="mt-6 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-between">
              ...
              <a className="link" href="/twitter" data-tippy-content="@twitter_handle">
                <svg
                  className="h-6 fill-current text-gray-600 hover:text-green-700"
                  role="img"
                  viewBox="0 0 24 24"
              ...
              <a className="link" href="/youtube" data-tippy-content="@youtube_handle">
                <svg
                  className="h-6 fill-current text-gray-600 hover:text-green-700"
                  role="img"
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <div class="space-y-2 col-span-1 bg-center absolute bottom-0">
            <div class="border-gold-light border-2 flex items-center p-2 rounded justify-between space-x-2">
              ...
              <a href="download/resume" class="text-gold-light hover:underline">
                Download
              </a>
            </div>
