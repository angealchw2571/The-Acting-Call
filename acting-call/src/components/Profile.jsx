  ...
  return (
    <>
      <div className="text-right text-white">
        ...
        <Link
          to={sessionData.profiles === null ? ("/profile/new") : ("/profile/edit")}
      ...
      {sessionData.profiles === null ? (<div className="text-center text-white"><h1>Looks like you don't have a profile</h1></div>) : (<div className="profileDiv">
